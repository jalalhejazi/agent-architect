---
description: Spec Creation Rules for Agent Architect
globs:
alwaysApply: false
version: 1.1
encoding: UTF-8
...
<option_a_flow>
  ...
  <actions>
    1. CHECK @.agent-architect/product/roadmap.md
...
Use the context-fetcher subagent to read @.agent-architect/product/mission-lite.md and @.agent-architect/product/tech-stack.md only if not already in context to ensure minimal context for spec alignment.
...
<date_determination_process>
  <primary_method>
    ...
    <process>
      1. CREATE directory if not exists: .agent-architect/specs/
      2. CREATE temporary file: .agent-architect/specs/.date-check
...
Use the file-creator subagent to create directory: .agent-architect/specs/YYYY-MM-DD-spec-name/ using the date from step 4.
...
Use the file-creator subagent to create the file: .agent-architect/specs/YYYY-MM-DD-spec-name/spec.md using this template:
...
Use the file-creator subagent to create the file: .agent-architect/specs/YYYY-MM-DD-spec-name/spec-lite.md for the purpose of establishing a condensed spec for efficient AI context usage.
...
<file_template>
  <header>
    ...
    This is the technical specification for the spec detailed in @.agent-architect/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<file_template>
  <header>
    ...
    This is the database schema implementation for the spec detailed in @.agent-architect/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<file_template>
  <header>
    ...
    This is the API specification for the spec detailed in @.agent-architect/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<review_request>
  ...
  - Spec Requirements: @.agent-architect/specs/YYYY-MM-DD-spec-name/spec.md
- Spec Summary: @.agent-architect/specs/YYYY-MM-DD-spec-name/spec-lite.md
- Technical Spec: @.agent-architect/specs/YYYY-MM-DD-spec-name/sub-specs/technical-spec.md
...
<conditional_reads>
  ...
  <manual_reads>
    <mission_lite>
      - IF NOT already in context: READ @.agent-architect/product/mission-lite.md
      - IF already in context: SKIP reading
    </mission_lite>
    <roadmap>
      - IF NOT already in context: READ @.agent-architect/product/roadmap.md
      - IF already in context: SKIP reading
    </roadmap>
    <decisions>
...
<decision_analysis>
  <review_against>
    - @.agent-architect/product/mission-lite.md (conditional)
- @.agent-architect/product/roadmap.md (conditional)
  </review_against>
  <criteria>
...
<decision_template>
  ...
  **Related Spec:** @.agent-architect/specs/YYYY-MM-DD-spec-name/
...
<execution_flow>
  IF user_confirms_yes:
    REFERENCE: @~/.agent-architect/instructions/core/execute-tasks.md
