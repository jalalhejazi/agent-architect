---
description: Analyze Current Product & Install Agent Architect
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
# Analyze Current Product & Install Agent Architect

## Overview

Install Agent Architect into an existing codebase, analyze current product state and progress.  Builds on plan-product.md
...
<context_questions>
  ...
  To properly set up Agent Architect, I need to understand:
...
Execute our standard flow for installing Agent Architect in existing products
...
<execution_prompt>
  @~/.agent-architect/instructions/core/plan-product.md

  I'm installing Agent Architect into an existing product. Here's what I've gathered:
...
<instructions>
  ...
  ALLOW: plan-product.md to create .agent-architect/product/ structure
</instructions>
...
Verify installation completeness and provide clear next steps for the user to start using Agent Architect with their existing codebase.

<verification_checklist>
  - [ ] .agent-architect/product/ directory created
...
<summary_template>
  ## ✅ Agent Architect Successfully Installed

  I've analyzed your [PRODUCT_TYPE] codebase and set up Agent Architect with documentation that reflects your actual implementation.
  ...
  - ✓ Product documentation in `.agent-architect/product/`
  - ✓ Roadmap with completed work in Phase 0
  - ✓ Tech stack reflecting actual dependencies

  ### Next Steps

  1. Review the generated documentation in `.agent-architect/product/`
  2. Make any necessary adjustments to reflect your vision
  3. See the Agent Architect README for usage instructions: https://github.com/jalalhejazi/agent-architect
  4. Start using Agent Architect for your next feature:
     ```
     @~/.agent-architect/instructions/core/create-spec.md
     ```

  Your codebase is now Agent Architect-enabled! 🚀
</summary_template>
...
<final_checklist>
  <verify>
    ...
    - [ ] Team can adopt Agent Architect workflow
  </verify>
</final_checklist>
