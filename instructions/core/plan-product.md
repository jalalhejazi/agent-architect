---
description: Product Planning Rules for Agent Architect
globs:
alwaysApply: false
version: 4.0
encoding: UTF-8
...
<data_sources>
  ...
  <fallback_sequence>
    1. @~/.agent-architect/standards/tech-stack.md
    2. @~/.claude/CLAUDE.md
    3. Cursor User Rules
  </fallback_sequence>
</data_sources>
...
Use the file-creator subagent to create the file: .agent-architect/product/mission.md and use the following template:
...
Use the file-creator subagent to create the file: .agent-architect/product/tech-stack.md and use the following template:
...
Use the file-creator subagent to create the file: .agent-architect/product/mission-lite.md for the purpose of establishing a condensed mission for efficient AI context usage.
...
Use the file-creator subagent to create the following file: .agent-architect/product/roadmap.md using the following template:
...
Use the file-creator subagent to create the file: .agent-architect/product/decisions.md using the following template:
...
<final_checklist>
  <verify>
    - [ ] All 5 files created in .agent-architect/product/
